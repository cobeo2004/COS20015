...
const GamesManagementPage = lazy(
  () => import("./pages/admin/GamesManagementPage")
);
const PlayersManagementPage = lazy(
  () => import("./pages/admin/PlayersManagementPage")
);
const AchievementsManagementPage = lazy(
  () => import("./pages/admin/AchievementsManagementPage")
);
...
const DeveloperDetailsPage = lazy(
  () => import("./pages/player/DeveloperDetailsPage")
);
