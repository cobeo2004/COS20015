              ...
              <div className="grid gap-6 md:grid-cols-2">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Your gaming statistics at a glance
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-lg">
                        {statsData.performance.totalScore.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-lg">
                        {statsData.performance.gamesPlayed}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">
                      ...
                      <span className="font-bold text-lg">
                        {statsData.performance.achievementCompletionRate.toFixed(
                          1
                        )}
                        %
                      </span>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-lg">
                        {statsData.performance.achievementsUnlocked}/
                        {statsData.performance.achievementsTotal}
                      </span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-lg">
                        {Math.floor(statsData.time.totalPlaytimeHours)}h{" "}
                        {Math.round(
                          (statsData.time.totalPlaytimeHours % 1) * 60
                        )}
                        m
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-lg">
                        {Math.floor(statsData.time.avgSessionDuration)}h{" "}
                        {Math.round(
                          (statsData.time.avgSessionDuration % 1) * 60
                        )}
                        m
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-lg">
                        {Math.floor(statsData.time.thisWeekHours)}h{" "}
                        {Math.round((statsData.time.thisWeekHours % 1) * 60)}m
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">This Month</span>
                      <span className="font-bold text-lg">
                        {Math.floor(statsData.time.thisMonthHours)}h{" "}
                        {Math.round((statsData.time.thisMonthHours % 1) * 60)}m
                      </span>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      {statsData.sessions.map((session) => (
                        <TableRow key={session.id}>
                          ...
                          <TableCell className="text-right">
                            {Math.floor(session.durationHours)}h{" "}
                            {Math.round((session.durationHours % 1) * 60)}m
                          </TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
